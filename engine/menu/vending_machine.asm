...
.enoughMoney
	...
	ld b, a
	ld c, 1
;	call GiveItem                                          ; in this version the vending machines
;	jr nc, .BagFull                                        ; are all broken on purpose
...
VendingPrices: ; 75000 (1d:5000)
	db FRESH_WATER,$00,$01,$00
	db SODA_POP,   $00,$01,$50
	db LEMONADE,   $00,$02,$00
