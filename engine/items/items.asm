...
Route12SnorlaxFluteCoords: ; e1fd (3:61fd)
	db 64,9  ; one space West of Snorlax
	db 63,10 ; one space North of Snorlax
	db 65,10 ; one space South of Snorlax
	db 64,11 ; one space East of Snorlax
	db $ff ; terminator
...
Route16SnorlaxFluteCoords: ; e206 (3:6206)
	db 10,36 ; one space East of Snorlax
	db 10,34 ; one space West of Snorlax
	db $ff ; terminator
