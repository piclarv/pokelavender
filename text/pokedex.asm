...
_QuilavaDexEntry::
	...
	next "you during battle."

	page "It means it will"
...
_MarillDexEntry::
	...
	next "bouy that keeps it"

	page "from drowning,"
	next "even in a"
	next "vicious current"
	dex
