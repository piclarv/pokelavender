...
CeladonGymText6:               ; new gym helper
	db $08 ; asm
	ld a, [wd77c]
	bit 7, a
	jr nz, .CeladonGymHelperAfter
	ld hl, CeladonGymHelperText
	call PrintText
	jr .done
.CeladonGymHelperAfter
	ld hl, CeladonGymHelperAfterText
	call PrintText
.done
	jp TextScriptEnd

CeladonGymHelperText:
	TX_FAR _CeladonGymHelperText
	db "@"

CeladonGymHelperAfterText:
	TX_FAR _CeladonGymHelperAfterText
	db "@"

CeladonGymText7: ; 48a6d (12:4a6d)
