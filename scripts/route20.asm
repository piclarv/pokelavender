...
Route20TrainerHeader11: ; this is new
	db $b ; flag's bit
	db ($2 << 4) ; trainer's view range
	dw wd7e7 ; flag's byte
	dw Route20BattleText11
	dw Route20AfterBattleText11
	dw Route20EndBattleText11
	dw Route20EndBattleText11
...
Route20Text11: ; 50e0d (14:4e0d)
	db $08 ; asm
	ld hl, Route20TrainerHeader11
	call TalkToTrainer
	jp TextScriptEnd

Route20HideMisty:
	ld a, HS_ROUTE_20_MISTY
	ld [wcc4d], a
	predef HideObject
...
Route20HideMistyText:
	TX_FAR _Route20EndBattleText11
	db "@"
...
Route20BattleText11: ; this is new
	TX_FAR _Route20BattleText11
	db "@"

Route20EndBattleText11:
	db $08
	ld hl, Route20HideMistyText
	call PrintText
	callba Route20HideMisty
	jp TextScriptEnd

Route20AfterBattleText11:
	TX_FAR _Route20AfterBattleText11
	db "@"

Route20Text13: ; 50ead (14:4ead)
