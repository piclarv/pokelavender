...
PewterGymTrainerHeader1: ; this is new
	db $3 ; flag's bit
	db ($4 << 4) ; trainer's view range
	dw wd755 ; flag's byte
	dw PewterGymBattleText2 ; 0x44d0 TextBeforeBattle
	dw PewterGymAfterBattleText2 ; 0x44da TextAfterBattle
	dw PewterGymEndBattleText2 ; 0x44d5 TextEndBattle
	dw PewterGymEndBattleText2 ; 0x44d5 TextEndBattle
...
PewterGymText5: ; 5c4a8 (17:44a8)
	TX_FAR _TM34PreReceiveText
	db "@"

PewterGymText6: ; 5c4ad (17:44ad)
	TX_FAR _ReceivedTM34Text
	db $0B
	TX_FAR _TM34ExplanationText
	db "@"

PewterGymText7: ; 5c4b7 (17:44b7)
...
PewterGymBattleText2: ; 5c4d0 (17:44d0)
	TX_FAR _PewterGymBattleText2
	db "@"

PewterGymEndBattleText2: ; 5c4d5 (17:44d5)
	TX_FAR _PewterGymEndBattleText2
	db "@"

PewterGymAfterBattleText2: ; 5c4da (17:44da)
	TX_FAR _PewterGymAfterBattleText2
	db "@"

PewterGymText4: ; 5c4df (17:44df)
	db $08 ; asm
	ld a, [wd72a]
	bit 0, a
