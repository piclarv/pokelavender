MonsterPalettes: ; 725c8 (1c:65c8)
	...
	db PAL_MEWTWO
	db PAL_MEW
	db PAL_WEEDLE		; Mareep
	db PAL_JIGGLYPUFF	; Flaaffy
	db PAL_RAICHU		; Ampharos
	db PAL_MAGMAR		; Cyndaquil
	db PAL_MAGMAR		; Quilava
	db PAL_CHARMELEON	; Typhlosion
	db PAL_BUTTERFREE	; Marill
