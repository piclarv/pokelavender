...
ENDC
	...
	db $a ; people
IF DEF(_OPTION_BEACH_HOUSE)
	db SPRITE_BUG_CATCHER, $7 + 4, $9 + 4, $ff, $d3, TRAINER | 1, SWIMMER + $C8, 2
	db SPRITE_BUG_CATCHER, $9 + 4, $c + 4, $ff, $d2, TRAINER | 2, SWIMMER + $C8, 3
ELSE
	db SPRITE_BUG_CATCHER, $7 + 4, $8 + 4, $ff, $d2, TRAINER | 1, SWIMMER + $C8, 2
	db SPRITE_BUG_CATCHER, $7 + 4, $d + 4, $ff, $d2, TRAINER | 2, SWIMMER + $C8, 3
ENDC
