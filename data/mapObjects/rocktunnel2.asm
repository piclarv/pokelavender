RockTunnel2Object: ; 0x4613d (size=100)
	...
	db SPRITE_BLACK_HAIR_BOY_2, $5 + 4, $3 + 4, $ff, $d0, TRAINER | $3, SUPER_NERD + $C8, $d
	db SPRITE_BLACK_HAIR_BOY_2, $15 + 4, $14 + 4, $ff, $d3, TRAINER | $4, BEAUTY + $C8, $10
	...
	db SPRITE_BLACK_HAIR_BOY_2, $1e + 4, $1a + 4, $ff, $d0, TRAINER | $8, BEAUTY + $C8, $11
