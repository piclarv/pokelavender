SilphCo7Object: ; 0x51ed7 (size=128)
	...
	db SPRITE_ROCKET, $1 + 4, $d + 4, $ff, $d0, TRAINER | $5, POKEMANIAC + $C8, $e
	db SPRITE_OAK_AIDE, $d + 4, $2 + 4, $ff, $d0, TRAINER | $6, SCIENTIST + $C8, $8
	db SPRITE_ROCKET, $2 + 4, $14 + 4, $ff, $d2, TRAINER | $7, ROCKET + $C8, $10
	db SPRITE_ROCKET, $e + 4, $13 + 4, $ff, $d3, TRAINER | $8, POKEMANIAC + $C8, $f
