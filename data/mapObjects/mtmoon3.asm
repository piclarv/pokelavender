MtMoon3Object: ; 0x49fdb (size=102)
	...
	db SPRITE_ROCKET, $10 + 4, $b + 4, $ff, $d0, TRAINER | $2, GIOVANNI + $C8, $5
	db SPRITE_ROCKET, $16 + 4, $f + 4, $ff, $d0, TRAINER | $3, ROCKET + $C8, $1
	db SPRITE_ROCKET, $b + 4, $1d + 4, $ff, $d1, TRAINER | $4, ROCKET + $C8, $2
	db SPRITE_ROCKET, $11 + 4, $1d + 4, $ff, $d2, TRAINER | $5, POKEMANIAC + $C8, $1
