Route20Object: ; 0x50113 (size=106)
	...
	db $2 ; signs
	db $7, $33, $c ; Route20Text12
	db $b, $39, $d ; Route20Text13
	...
	db SPRITE_BUG_CATCHER, $9 + 4, $22 + 4, $ff, $d1, TRAINER | $7, BIRD_KEEPER + $C8, $b
	...
	db SPRITE_LORELEI, $6 + 4, $32 + 4, $ff, $d2, TRAINER | $b, MISTY + $C8, $2
