RockTunnel1Object: ; 0x445f6 (size=127)
	...
	db SPRITE_BLACK_HAIR_BOY_2, $8 + 4, $17 + 4, $ff, $d2, TRAINER | $4, JR__TRAINER_M + $C8, $a
	...
	db SPRITE_BOULDER, $18 + 4, $14 + 4, $ff, BOULDER_MOVEMENT_BYTE_2, $8
	db SPRITE_BOULDER, $19 + 4, $14 + 4, $ff, BOULDER_MOVEMENT_BYTE_2, $9
	db SPRITE_BOULDER, $1a + 4, $14 + 4, $ff, BOULDER_MOVEMENT_BYTE_2, $a
	db SPRITE_BOULDER, $1b + 4, $14 + 4, $ff, BOULDER_MOVEMENT_BYTE_2, $b
