CeruleanGymObject: ; 0x5c834 (size=50)
	...
	db $5 ; people
	db SPRITE_LORELEI, $2 + 4, $4 + 4, $ff, $d0, TRAINER | $1, MISTY + $C8, $1
	db SPRITE_LASS, $3 + 4, $2 + 4, $ff, $d3, TRAINER | $2, JR__TRAINER_F + $C8, $1
	db SPRITE_SWIMMER, $7 + 4, $8 + 4, $ff, $d2, TRAINER | $3, SWIMMER + $C8, $1
	db SPRITE_LASS, $8 + 4, $2 + 4, $ff, $d3, TRAINER | $4, COOLTRAINER_F + $C8, $1
	db SPRITE_GYM_HELPER, $a + 4, $7 + 4, $ff, $d0, $5 ; person
