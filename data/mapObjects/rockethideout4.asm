RocketHideout4Object: ; 0x455f1 (size=95)
	...
	db SPRITE_ROCKET, $c + 4, $17 + 4, $ff, $d0, TRAINER | $2, POKEMANIAC + $C8, $7
	db SPRITE_ROCKET, $c + 4, $1a + 4, $ff, $d0, TRAINER | $3, ROCKET + $C8, $9
	db SPRITE_ROCKET, $2 + 4, $b + 4, $ff, $d0, TRAINER | $4, POKEMANIAC + $C8, $8
	...
	db SPRITE_BALL, $2 + 4, $19 + 4, $ff, $ff, ITEM | $8, HM_01
