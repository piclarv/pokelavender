...
PewterMartText1:: ; 2449 (0:2449)
	db $FE,9,GREAT_BALL,SUPER_POTION,ESCAPE_ROPE,ANTIDOTE,BURN_HEAL,AWAKENING
	db PARLYZ_HEAL,REVIVE,SUPER_REPEL,$FF

; Cerulean
CeruleanMartText1:: ; 2453 (0:2453)
	db $FE,9,GREAT_BALL,SUPER_POTION,SUPER_REPEL,ANTIDOTE,BURN_HEAL,AWAKENING
	db PARLYZ_HEAL,FULL_HEAL,REVIVE,$FF
...
VermilionMartText1:: ; 2461 (0:2461)
	db $FE,7,POKE_BALL,SUPER_POTION,ICE_HEAL,AWAKENING,PARLYZ_HEAL
	db REPEL,ESCAPE_ROPE,$FF

; Lavender
LavenderMartText1:: ; 246a (0:246a)
	db $FE,7,POKE_BALL,POTION,REPEL,AWAKENING
	db ANTIDOTE,BURN_HEAL,PARLYZ_HEAL,$FF

; Celadon Dept. Store 2F (1)
CeladonMart2Text1:: ; 2476 (0:2476)
	db $FE,8,POKE_BALL,POTION,REPEL,ANTIDOTE
	db BURN_HEAL,ICE_HEAL,AWAKENING,PARLYZ_HEAL,$FF

; Celadon Dept. Store 2F (2)
CeladonMart2Text2:: ; 2482 (0:2482)
	db $FE,9,TM_32,TM_33,TM_02,TM_08,TM_37,TM_01,TM_20,TM_09,TM_16,$FF
...
FuchsiaMartText1:: ; 24a8 (0:24a8)
	db $FE,9,ULTRA_BALL,GREAT_BALL,HYPER_POTION,REVIVE,FULL_HEAL
	db MAX_REPEL,FRESH_WATER,SODA_POP,LEMONADE,$FF

; unused? 24b1
	db $FE,5,MASTER_BALL,HYPER_POTION,SUPER_POTION,FULL_HEAL,REVIVE,$FF
...
SaffronMartText1:: ; 24c3 (0:24c3)
	db $FE,6,ULTRA_BALL,HYPER_POTION,MAX_REPEL,ESCAPE_ROPE,FULL_HEAL
	db MAX_REVIVE,$FF
