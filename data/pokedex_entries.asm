PokedexEntryPointers: ; 4047e (10:447e)
	...
	dw PinsirDexEntry
	dw TangelaDexEntry
	dw MareepDexEntry	; Missingno
	dw FlaaffyDexEntry	; Missingno
	...
	dw DrowzeeDexEntry
	dw GolemDexEntry
	dw AmpharosDexEntry	; Missingno
	dw MagmarDexEntry
	dw CyndaquilDexEntry    ; Missingno
	dw ElectabuzzDexEntry
	dw MagnetonDexEntry
	dw KoffingDexEntry
	dw QuilavaDexEntry      ; Missingno
	dw MankeyDexEntry
	dw SeelDexEntry
	dw DiglettDexEntry
	dw TaurosDexEntry
	dw TyphlosionDexEntry	; Missingno
	dw MarillDexEntry       ; Missingno
	dw AzumarillDexEntry    ; Missingno
